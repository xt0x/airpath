...
Antimeridian behavior is pinned by a shared fixture under `packages/shared-types/fixtures/geojson` so the TypeScript and Go GeoJSON implementations stay aligned.
